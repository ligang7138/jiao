...
export const legacyRouteMap = [
  ...
  {
    legacyPage: '/admin/post/index.php',
    legacyDo: 'post.index',
    api: { method: 'GET', uri: '/api/v1/admin/roles' },
    route: '/system/roles',
    permission: 'post.index',
  },
  {
    legacyPage: '/admin/post/privilege.php',
    legacyDo: 'post.privilege',
    api: { method: 'PUT', uri: '/api/v1/admin/roles/{id}/privilege' },
    route: '/system/roles',
    permission: 'post.privilege',
  },
  {
    legacyPage: '/admin/privilege/index.php',
    legacyDo: 'privilege.index',
    api: { method: 'GET', uri: '/api/v1/admin/permissions' },
    route: '/system/permissions',
    permission: 'privilege.index',
  },
  {
    legacyPage: '/admin/log/index.php',
    legacyDo: 'log.index',
    api: { method: 'GET', uri: '/api/v1/admin/logs' },
    route: '/system/logs',
